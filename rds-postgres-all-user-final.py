...
APP_READ_USER_KEY = os.getenv("APP_READ_USER_KEY", "app_user_r")
APP_READ_USER_PASS_KEY = os.getenv("APP_READ_USER_PASS_KEY", "app_user_r_pass")
APP_READWRITE_USER_KEY = os.getenv("APP_READWRITE_USER_KEY", "app_user_rw")
APP_READWRITE_USER_PASS_KEY = os.getenv("APP_READWRITE_USER_PASS_KEY", "app_user_rw_pass")
PIPELINE_READWRITE_USER_KEY = os.getenv("PIPELINE_READWRITE_USER_KEY", "pipeline_user_rw")
PIPELINE_READWRITE_USER_PASS_KEY = os.getenv("PIPELINE_READWRITE_USER_PASS_KEY", "pipeline_user_rw_pass")
MASTER_USER_KEY = os.getenv("MASTER_USER_KEY", "username")
MASTER_PASS_KEY = os.getenv("MASTER_PASS_KEY", "password")
